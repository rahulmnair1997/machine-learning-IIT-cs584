...
# train_pri = train_data.groupby('CAR_USE')[1]
...
prob_test_comm = (prob_comm_test*test_split)/((prob_comm_train*train_split)+(prob_comm_test*test_split))
print(prob_test_comm)


# In[10]:


prob_train_pri = (prob_pri_train*train_split)/((prob_pri_train*train_split)+(prob_pri_test*test_split))
print(prob_train_pri)
...
# import itertools
# by_ip = {k: list(g) for k, g in itertools.groupby(car_dict.keys())}
# by_ip
...
list_entropy_second_layer_left
...
proper_set_occ_2
# min_set_occ_split_2 = max_entropy(occ_dict, proper_set_occ_2) 
# min_set_occ_split_2
...
list_entropy_second_layer_right
...
print(grouped1)
# abc = pandas.DataFrame(grouped1)
# print(abc)
# xyz = abc[abc.EDUCATION[0]]
